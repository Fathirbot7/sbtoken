...
me = LINE("EyWixxz0jxpzQnfAb3z1.DspRQeIW2CR0azBMktfXyq.JSTuaeOzcR8330ItNj3W0/zqHBuE8w9Tyi9hhYBqMwU=")
...
def bot(op):
    ...
    try:
        ...
        if op.type == 5:
            ...
            sendMention(op.param1, op.param1, "MAKASI UDAH ADd","")
        if op.type == 15:
            Gr = op.param1
            Cj = op.param2
                        ...
                        if Gr in Sid['Red']:
                            ...
                            if Name in Sid['Reason'][Gr]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        me.sendMessage(Gr, "Hayoo.. " + " " + nick[0] + "" + "\nNGAPAIN NGINTIP KK😁😁😂. . .\nSINI CHAT BIAR RAME😘😀👌👌")
                                        me.sendImageWithURL(Gr, "http://dl.profile.line-cdn.net/" + Np)
                                    else:
                                        me.sendMessage(Gr, "Hayoo.. " + " " + nick[1] + " " + "\nJangan ngintip.. . . .\nMasuk  ayox... ")
                                        me.sendImageWithURL(Gr, "http://dl.profile.line-cdn.net/" + Np)
                                else:
                                    me.sendMessage(Gr, "NAHH.. " + " " + Name + " " + "\nNGAPAIN NGINTIP KK 😁😁😂\nAYO SINI NGELABA BARENG 😘😘😀😀👌👌 ")
                                    me.sendImageWithURL(Gr, "http://dl.profile.line-cdn.net/" + Np)
                        else:
                            pass
                else:
